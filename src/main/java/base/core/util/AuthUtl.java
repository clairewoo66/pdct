...
public class AuthUtl {
    ...
    public static String calculateUserPassword(String alg, String pass) {
        ...
        String base64_hash_pass = null;
        try {
            base64_hash_pass = _Base64Hash(_alg, pass.getBytes("utf-8"));
            return  base64_hash_pass;
    ...
    public static void main(String[] args) {
        System.out.println(calculateUserPassword(HASH_METHOD_SHA,"123456"));
    }
}